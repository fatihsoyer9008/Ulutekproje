...
const TransactionEntitySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'syncState': PropertySchema(
      ...
      name: r'syncState',
      type: IsarType.string,
      enumMap: _TransactionEntitysyncStateEnumValueMap,
    ),
...
int _transactionEntityEstimateSize(
  ...
  {
    final value = object.clientRecordId;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
...
void _transactionEntitySerialize(
  ...
  writer.writeString(offsets[3], object.clientRecordId);
  writer.writeDateTime(offsets[4], object.createdAt);
  writer.writeDateTime(offsets[5], object.date);
  writer.writeString(offsets[6], object.merchantName);
  writer.writeString(offsets[7], object.note);
  writer.writeString(offsets[8], object.ownerKey);
  writer.writeString(offsets[9], object.rawOcrText);
  writer.writeString(offsets[10], object.source.name);
  writer.writeString(offsets[11], object.syncState.name);
  writer.writeString(offsets[12], object.transactionType.name);
...
TransactionEntity _transactionEntityDeserialize(
  ...
  object.category = _TransactionEntitycategoryValueEnumMap[
          reader.readStringOrNull(offsets[1])] ??
      TransactionCategory.market;
  object.categoryName = reader.readStringOrNull(offsets[2]);
  object.clientRecordId = reader.readStringOrNull(offsets[3]);
  object.createdAt = reader.readDateTime(offsets[4]);
  object.date = reader.readDateTime(offsets[5]);
  object.id = id;
  object.merchantName = reader.readStringOrNull(offsets[6]);
  object.note = reader.readStringOrNull(offsets[7]);
  object.ownerKey = reader.readStringOrNull(offsets[8]);
  object.rawOcrText = reader.readStringOrNull(offsets[9]);
  object.source = _TransactionEntitysourceValueEnumMap[
          reader.readStringOrNull(offsets[10])] ??
      TransactionSource.ocrRegex;
  object.syncState = _TransactionEntitysyncStateValueEnumMap[
...
P _transactionEntityDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_TransactionEntitycategoryValueEnumMap[
    ...
    case 9:
      return (reader.readStringOrNull(offset)) as P;
    case 10:
      return (_TransactionEntitysourceValueEnumMap[
              reader.readStringOrNull(offset)] ??
          TransactionSource.ocrRegex) as P;
    case 11:
      return (_TransactionEntitysyncStateValueEnumMap[
              reader.readStringOrNull(offset)] ??
...
const _TransactionEntitysyncStateEnumValueMap = {
...
const _TransactionEntitysyncStateValueEnumMap = {
...
extension TransactionEntityQueryProperty
  ...
  QueryBuilder<TransactionEntity, SyncState, QQueryOperations>
      syncStateProperty() {
    return QueryBuilder.apply(this, (query) {
