...
extension ReceiptEntityByIndex on IsarCollection<ReceiptEntity> {
  Future<ReceiptEntity?> getByTransactionId(int transactionId) {
    return getByIndex(r'transactionId', [transactionId]);
  }

  ReceiptEntity? getByTransactionIdSync(int transactionId) {
  ...
  Future<Id> putByTransactionId(ReceiptEntity object) {
    return putByIndex(r'transactionId', object);
  }

  Id putByTransactionIdSync(ReceiptEntity object, {bool saveLinks = true}) {
    return putByIndexSync(r'transactionId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByTransactionId(List<ReceiptEntity> objects) {
...
extension ReceiptEntityQueryWhereSort
  ...
  QueryBuilder<ReceiptEntity, ReceiptEntity, QAfterWhere> anyTransactionId() {
    return QueryBuilder.apply(this, (query) {
